<?php /* Smarty version Smarty-3.1.7, created on 2018-12-18 08:22:40
         compiled from "/var/www/html/Sirenis/includes/runtime/../../layouts/v7/modules/Vtiger/Export.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5884190975c17cf8a16f694-17956355%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fbc7060cef6c4d5ee1ff8cc1d490597460c2d258' => 
    array (
      0 => '/var/www/html/Sirenis/includes/runtime/../../layouts/v7/modules/Vtiger/Export.tpl',
      1 => 1545112042,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5884190975c17cf8a16f694-17956355',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5c17cf8a3c82e',
  'variables' => 
  array (
    'SOURCE_MODULE' => 0,
    'VIEWID' => 0,
...
<?php if ($_valid && !is_callable('content_5c17cf8a3c82e')) {function content_5c17cf8a3c82e($_smarty_tpl) {?>
...
</label></div><br><div><input type="radio" name="mode" value="ExportFilter" id="group4" style="margin:2px 0 -4px" /><label style="font-weight:normal" for="group4"><?php echo vtranslate('LBL_EXPORT_FILTER_DATA',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</label></div><div><table><thead><th><?php echo vtranslate('LBL_EXPORT_FORMAT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;</th></thead><tbody><tr><td>CSV</td><td>Excel</td></tr><tr><td><input type="radio"  name="export_type" value="text/csv" checked="checked" /></td><td><input type="radio"  name="export_type" value="excel" /></td></tr></tbody></table></div><?php if ($_smarty_tpl->tpl_vars['MULTI_CURRENCY']->value){?><br><div class="row"><div class="col-lg-8 col-md-8 col-lg-pull-0"><strong><?php echo vtranslate('LBL_EXPORT_LINEITEM_CURRENCY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
