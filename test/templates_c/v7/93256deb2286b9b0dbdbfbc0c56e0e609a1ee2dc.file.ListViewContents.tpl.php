<?php /* Smarty version Smarty-3.1.7, created on 2018-11-22 18:53:05
         compiled from "/var/www/html/Sirenis/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14506387305bf6fb11c823d8-14722384%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '93256deb2286b9b0dbdbfbc0c56e0e609a1ee2dc' => 
    array (
      0 => '/var/www/html/Sirenis/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl',
      1 => 1542884364,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14506387305bf6fb11c823d8-14722384',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bf6fb11f3ba0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bf6fb11f3ba0')) {function content_5bf6fb11f3ba0($_smarty_tpl) {?>
...
"
									 ...
									 data-toggle="tooltip" data-placement="bottom" data-container="body"  style='display: inline-block;margin-left: 5px;'>
									<i class="fa fa-th-large" style="margin-left: 5px;margin-right: 5px;"></i>									
								</div>
								<div class="listColumnFilter" style='display: inline-block;margin-left: 5px;'>								
									<a id="<?php echo ($_smarty_tpl->tpl_vars['MODULE']->value).('_link_TablaPivot');?>
" href="<?php echo str_replace('view=List','view=TablaPivot',$_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getListViewUrl());?>
" class="hidden"><i class="fa fa-plus"></i></a>
								</div>
							</div>
						<?php }?>
					</div>
...
window.onload = function(){
		let mod = "<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
";
		console.log(mod);
		if( !!document.getElementById(mod+"_listView_advancedAction_Tabla_Pivot") ){
			console.log("Eliminado la clase hidden");
			document.getElementById(mod+'_link_TablaPivot').classList.remove('hidden');
		}else{
			console.log("Eliminado el coso");
			document.getElementById(mod+'_link_TablaPivot').remove();
		}
}
</script>
<?php }} ?>