<?php /* Smarty version Smarty-3.1.7, created on 2018-11-23 08:40:33
         compiled from "/var/www/html/Sirenis/includes/runtime/../../layouts/v7/modules/Contacts/DetailViewHeaderTitle.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13620564225bf7bd01aa8296-99066100%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e8398c52f94d408e8a6fb535dc5783f867d52320' => 
    array (
      0 => '/var/www/html/Sirenis/includes/runtime/../../layouts/v7/modules/Contacts/DetailViewHeaderTitle.tpl',
      1 => 1542884364,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13620564225bf7bd01aa8296-99066100',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bf7bd01b2f42',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bf7bd01b2f42')) {function content_5bf7bd01b2f42($_smarty_tpl) {?>
<div class="col-lg-6 col-md-6 col-sm-6"><input type = "hidden" id = "hdnContactId" value = "<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
"/><div class="record-header clearfix "><div class="hidden-sm hidden-xs recordImage bgcontacts app-<?php echo $_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value;?>
...
</span><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0&&($_smarty_tpl->tpl_vars['RECORD']->value->get($_smarty_tpl->tpl_vars['NAME_FIELD']->value))){?>&nbsp;<?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php }?><?php }?><?php } ?></span>&nbsp;&nbsp;&nbsp;<img id = "imgActivo" style = "position: relative; top: -1px"/></h4></div><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("DetailViewHeaderFieldsView.tpl",$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<script type="text/javascript">
	jQuery(document).on('ready', function(){
		jQuery.ajax({
			url : 'index.php?module=Contacts&action=isActive',
			data : {'contactid' : jQuery('#hdnContactId').val()},
			dataType : 'json'
		})
		.done(function(response){
			console.log(response);
			if(response['clienteactivo']){
				jQuery('#imgActivo').attr('src', 'layouts/v7/skins/images/Enable.png');
			}
			else{				
				jQuery('#imgActivo').attr('src', 'layouts/v7/skins/images/Disable.png');
			}
		})
