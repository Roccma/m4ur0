...
if($moduleInstance){
	...
	$blockInstance = Vtiger_Block::getInstance("LBL_CONTACT_INFORMATION",$moduleInstance);
		...
		$firstname = Vtiger_Field::getInstance('firstname', $moduleInstance);
		$lastname = Vtiger_Field::getInstance('lastname', $moduleInstance);
		$birthday = Vtiger_Field::getInstance('birthday', $moduleInstance);
		$tipodoc = Vtiger_Field::getInstance('tipodoc', $moduleInstance);
		$documento = Vtiger_Field::getInstance('documento', $moduleInstance);

		$filter1 = new Vtiger_Filter();
		$filter1->name = 'All';
		$filter1->isdefault = true;
		$moduleInstance->addFilter($filter1);
		$filter1->addField($firstname)->addField($lastname,1)->addField($birthday, 2)->addField($tipodoc, 3)->addField($documento, 4);
