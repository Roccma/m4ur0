...
$moduleInstance = Vtiger_Module::getInstance("Reservas");

if(!$moduleInstance){		
	$moduleInstance = new Vtiger_Module();
    $moduleInstance->name = "Reservas";
    $moduleInstance->parent = "Sales";
    $moduleInstance->save();

    // Schema Setup
    $moduleInstance->initTables();
    mkdir("modules/Reservas");
}

if($moduleInstance){
    // Schema Setup
	$blockInstance = Vtiger_Block::getInstance("LBL_Reservas_INFORMATION",$moduleInstance);
	if(!$blockInstance){
		$blockInstance = new Vtiger_Block();
		$blockInstance->label = "LBL_Reservas_INFORMATION";
		...
		if(!$fieldInstance) {
			...
			$fieldInstance->label   = 'Membres&aacute;�a';
			$fieldInstance->table   = $moduleInstance->basetable;
