					...
					<div class="col-lg-6">
						<div class="well exportContents">
							...
							<div style="margin-left: 50px;">
								...
								<br>
								<div>
									<input type="radio" name="mode" value="ExportFilter" id="group4" style="margin:2px 0 -4px" />
									<label style="font-weight:normal" for="group4">{vtranslate('LBL_EXPORT_FILTER_DATA',$MODULE)}&nbsp;</label>
								</div>
								<br>
								<div>
								...
								<div>
									<table>
										<thead>
											<th>{vtranslate('LBL_EXPORT_FORMAT',$MODULE)}&nbsp;</th>
										</thead>
										<tbody>
											<tr>
												<td>CSV</td><td>Excel</td>
											</tr>
											<tr>
												<td>
													<input type="radio"  name="export_type" value="text/csv" checked="checked" />
												</td>
												<td>
