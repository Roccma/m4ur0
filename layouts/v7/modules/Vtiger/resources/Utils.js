...
var vtUtils = {
	...
	showSelect2ElementView : function(selectElement, params) {
        ...
        //START CODIGO AGREGADO PARA QUE ANDEN LOS UITYPE 33
		if(params.fieldinfo){
			var selectores=selectElement;
			for (var i = 0; i < selectores.length; i++) {
				if ($(selectElement[i]).prop('multiple')) {
					var name = $(selectElement[i]).prop('name');
		...
		//FIN CODIGO AGREGADO PARA QUE ANDEN LOS UITYPE 33
