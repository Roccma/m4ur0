						...
						{if $MODULE_MODEL->isFilterColumnEnabled()}
							<div id="listColumnFilterContainer">
								...
								<div class="listColumnFilter" style='display: inline-block;margin-left: 5px;'>								
									<a id="{$MODULE|cat:'_link_TablaPivot'}" href="{str_replace('view=List','view=TablaPivot',$MODULE_MODEL->getListViewUrl())}" class="hidden"><i class="fa fa-plus"></i></a>
								</div>
							</div>
						{/if}
					</div>
...
window.onload = function(){
		let mod = "{/literal}{$MODULE}{literal}";
		console.log(mod);
