	...
	<div class="col-lg-12">
		<div class="col-lg-5">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/solventa.png">
				<div>
			...
			<div class="marketingDiv widgetHeight">
				{if $JSON_DATA}
					<div class="">
								...
								<img class="img-responsive " src="layouts/v7/resources/Images/logo_sirenis.png"  >
