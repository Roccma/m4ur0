...
class Settings_CustomerPortal_Index_View extends Settings_Vtiger_Index_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$widgetsModules = array('HelpDesk', 'Faq', 'Documents', 'SolicitudesReservas', 'RedimirDias');
		...
		$log->debug("widgets mauro: " . var_export($widgets, true). " - " . var_export($widgetsModuleList, true) );
