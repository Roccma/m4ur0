Vtiger_Index_Js("Facebook_Index_Js",{
	...
	loadPages(){
		FB.api('/me?fields=accounts', response => {
			...
			if(response && response.accounts){
				Vtiger_Helper_Js.showPnotify({"title":"Se obtuvieron las paginas correctamente. Cantidad: " + response.accounts.data.length});
	...
	save(data){
	    ...
	    AppConnector.request(params).then(function(response){
	    	console.log(response);
	    	Vtiger_Helper_Js.showPnotify({"title":"Página guardada correctamente"});
	    });
	},
