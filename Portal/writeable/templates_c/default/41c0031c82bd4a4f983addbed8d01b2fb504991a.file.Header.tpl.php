<?php /* Smarty version Smarty-3.1.19, created on 2019-01-21 16:39:48
         compiled from "/var/www/html/Sirenis/Portal/layouts/default/templates/Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3820910875c2f39f8d42f96-65606665%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '41c0031c82bd4a4f983addbed8d01b2fb504991a' => 
    array (
      0 => '/var/www/html/Sirenis/Portal/layouts/default/templates/Header.tpl',
      1 => 1547091665,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3820910875c2f39f8d42f96-65606665',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5c2f39f8dc6246_15171582',
  'variables' => 
  array (
    'MODULE' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5c2f39f8dc6246_15171582')) {function content_5c2f39f8dc6246_15171582($_smarty_tpl) {?>
...
"></script>
		...
		<style>
		    ...
		    #divMyProfile, #divSolicitudesReservas, #divRedimirDias, #divNoticias{
		    	position: fixed;
		    	top: 59px;
		    	bottom: 0px;
		    	left: 0px;
	        ...
	        #profileContainer2, #solicitudesReservasContainer, #redimirDiasContainer{
	        	margin: 0 auto; 
	        ...
	        #solicitudesReservasForm < .modal-content{
	        	widows: 500px !important;
	        }

	        .modal-content:has(> #solicitudesReservasForm) {
			    widows: 500px !important;
			}
			...
			<div class="collapse navbar-collapse" role="navigation" style = "margin-right: 25px;">
				...
				<div class="col-lg-9 col-md-9" title="logo.png">
					<a class="logo-left" href="index.php">
						<img style = "width: 205px; height: auto; position: relative; top: -7px" src="<?php echo get_logo();?>
">
					</a>
						...
						<ul class="nav navbar-nav navbar-right headerLinks">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" id = "profileContainer">
									...
									<img alt="Contact Picture" style="width: 40px; height: 40px; border-radius: 50px; position: relative; top: -7px;" ng-if= 'contactDetails.imagedata != null' ng-src="data:{{contactDetails.imagetype}};base64,{{contactDetails.imagedata}}" alt="User image"> 
