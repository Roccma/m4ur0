			...
			language: language
				...
				.success(function (result) {
					...
					if(lang == 'en_us'){
						...
						$('a[data-columnname="Pasajero 1"]').html("Passenger 1");
						$('a[data-columnname="Pasajero 2"]').html("Passenger 2");
...
function RedimirDias_EditView_Component($scope, $modalInstance, record, api, webapp, module, $timeout, $translatePartialLoader, language, $filter, $http, editStatus) {
	...
	if(lang == 'es_es'){
		...
		$scope.redestado = {id : 'Pendiente', name : 'Pending'};
	}
