 ...
 * AngularJS
 */
window.module = angular.module('portalapp', ['ui.bootstrap', 'ngProgress', 'monospaced.elastic', 'pascalprecht.translate', 'modelOptions', 'ui.select', 'ui.bootstrap.timepicker', 'ngSanitize', 'ngCsv', 'xeditable', 'ng-bootstrap-datepicker', 'LocalStorageModule']);
...
window.module.filter('replaceSeparatorCharacters', function(){
	return function(text){
		let newText = "";
		let lang = localStorage.getItem('language');
		if(lang == 'es_es')
			newText = text.replace('|##|', 'y');
		else if(lang == 'en_us')
