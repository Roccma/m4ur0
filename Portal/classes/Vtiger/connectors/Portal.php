...
class Vtiger_Portal_Connector extends Vtiger_PortalBase_Connector {
	...
	public function fetchRecords($module, $language, $label, $q = false, $filter = false, $pageNo = false, $pageLimit = false, $orderBy = false, $order = false) {
		$username = Portal_Session::get('username');
		$password = Portal_Session::get('password');
		$this->auth = array('Authorization' => 'Basic '.base64_encode($username.':'.$password));
	...
	public function getDataSolicitudReserva($query) {
		$username = Portal_Session::get('username');
		$password = Portal_Session::get('password');
		$this->auth = array('Authorization' => 'Basic '.base64_encode($username.':'.$password));

		$params = array(
			'_operation' => 'getDataSolicitudReserva',
			'module' => 'SolicitudesReservas',
			'searchKey' => $query,
			'username' => $username,
			'password' => $password
		);
	...
	public function getDiasDisponibles($fechaDesde, $fechaHasta, $record) {
		$username = Portal_Session::get('username');
		$password = Portal_Session::get('password');
		$this->auth = array('Authorization' => 'Basic '.base64_encode($username.':'.$password));

		$params = array(
			'_operation' => 'getDiasDisponibles',
			'module' => 'RedimirDias',
	...
	public function getDataRedimirDias($query) {
		$username = Portal_Session::get('username');
		$password = Portal_Session::get('password');
		$this->auth = array('Authorization' => 'Basic '.base64_encode($username.':'.$password));

		$params = array(
			'_operation' => 'getDataRedimirDias',
			'module' => 'RedimirDias',
			'searchKey' => $query,
			'username' => $username,
			'password' => $password
	...
	public function getDataNoticia($query) {
		$username = Portal_Session::get('username');
		$password = Portal_Session::get('password');
		$this->auth = array('Authorization' => 'Basic '.base64_encode($username.':'.$password));

		$params = array(
			'_operation' => 'getDataNoticia',
			'module' => 'Noticias',
			'searchKey' => $query,
			'username' => $username,
			'password' => $password
	...
	public function getNoticias($query) {
		$username = Portal_Session::get('username');
		$password = Portal_Session::get('password');
		$this->auth = array('Authorization' => 'Basic '.base64_encode($username.':'.$password));

		$params = array(
			'_operation' => 'getNoticias',
			'module' => 'Noticias',
			'language' => $query,
			'username' => $username,
			'password' => $password
	...
	public function getContactsPortal() {
		$username = Portal_Session::get('username');
		$password = Portal_Session::get('password');
		$this->auth = array('Authorization' => 'Basic '.base64_encode($username.':'.$password));

		$params = array(
			'_operation' => 'getContactsPortal',
			'username' => $username,
			'password' => $password
		);
		return self::api($params);
