...
class Portal_FetchProfile_API extends Portal_Default_API {
	...
	protected $allowedFields = array(
		'contactFields' => array('firstname', 'lastname', 'agency_type', 'agency_number', 'number_employees', 'number_locations', 'agency_name', 'imagedata', 'imagetype', 'number_storefronts', 'mailingcountry', 'agency_kind', 'city', 'travel_affiliation', 'mailingstate', 'mailingzip', 'mailingstreet', 'address2', 'homephone', 'ext', 'fax', 'email', 'web_page', 'top_selling_destinations', 'top_specialities', 'tag_line', 'state'),
